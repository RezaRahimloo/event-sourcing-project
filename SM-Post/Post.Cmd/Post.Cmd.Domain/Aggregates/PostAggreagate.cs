...
{
    public class PostAggreagate : AggregateRoot
    {
        private bool _active;
        private string _author;
        private readonly Dictionary<Guid, Tuple<string, string>> _comments = new(); // item 2 is username item 1 is comment
        ...
        public PostAggreagate(Guid id, string author, string message)
        {
        ...
        public void DeletePost(string username)
        {
            ...
            {
                throw new InvalidOperationException("You are not allowed to delete a post that was made by sombody else!");
            }
